-- INSERT
-- 3-44 Book테이블에 '스포츠 의학' 도서를 추가하세요. 한솔의학서적에서 출간했고, 가격은 90,000원입니다.
...
-- 3-46 imported_book에 있는 데이터를 Book 테이블에 모두 삽입하시오.
-- 한 테이블에 있는 많은 데이터를 다른 테이블로 복사하는데 가장 효과적인 방법
INSERT INTO Book (bookid, bookname, publisher, price)
SELECT bookid, bookname, publisher, price
  FROM Imported_Book;

-- 추가. 테이블의 숫자형 타입으로된 PK값이 자동으로 증가하도록 만들고 사용하려면...
