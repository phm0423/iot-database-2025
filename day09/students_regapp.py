...
import pymysql  # mysql_connector 등 다른 모듈도 사용추천
...
# ent1.config(state='readonly')   # 값을 입력못하게 방지
...
## 4-5. 트리뷰 설정
for col in cols:
    dataView.heading(col, text=col)                 # 각 열 제목을 cols 변수하나씩 지정
